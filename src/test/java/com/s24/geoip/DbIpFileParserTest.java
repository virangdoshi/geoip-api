...
public class DbIpFileParserTest {
    ...
    public void shouldParseCsvFile() throws Exception {
        ...
        assertEquals("Omsk", entry1.getRegion());
        ...
        assertEquals("Asia/Omsk", entry1.getTimezoneName());
        assertEquals("OJSC \"Sibirtelecom\"", entry1.getIspName());
        assertEquals("dsl", entry1.getConnectionType());
        assertEquals("OJSC Sibirtelecom", entry1.getOrganizationName());
        ...
        assertEquals("Stockholm", entry2.getRegion());
        ...
        assertEquals("Europe/Stockholm", entry2.getTimezoneName());
        assertEquals("HI3G", entry2.getIspName());
        assertEquals("wireless", entry2.getConnectionType());
        assertEquals("Hi3G Access AB", entry2.getOrganizationName());
        ...
        assertEquals("Western Cape", entry3.getRegion());
        ...
        assertEquals("Africa/Johannesburg", entry3.getTimezoneName());
        assertEquals("Frogfoot Networks", entry3.getIspName());
        assertNull(entry3.getConnectionType());
        assertEquals("Frogfoot Networks", entry3.getOrganizationName());
    }
}
